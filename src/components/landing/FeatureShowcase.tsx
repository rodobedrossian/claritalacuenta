      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <FeatureCard
            ...
            description="Dictá tu gasto y la IA lo interpreta. 'Gasté 5 lucas en el super' y listo."
          ...
          >
            <div className="bg-muted/30 rounded-xl p-4 space-y-3">
              ...
              <div className="space-y-2">
                {[
                  { name: "Mercado Libre", amount: "-$45.320" },
                  { name: "Spotify", amount: "-$2.299" },
                  { name: "Uber", amount: "-$8.750" },
                ].map((tx, i) => (
                  <motion.div
                    key={tx.name}
          ...
          >
            <div className="bg-muted/30 rounded-xl p-4 space-y-3">
              {[
                { name: "Viaje a Europa", progress: 65, target: "USD 3.000" },
                { name: "Fondo de emergencia", progress: 88, target: "$500.000" },
              ].map((goal, i) => (
                <motion.div
                  key={goal.name}
