          ...
          <Alert className="bg-muted/50 border-muted-foreground/20">
            ...
            <AlertDescription className="text-xs space-y-2 mt-2">
              ...
              <ol className="list-decimal list-inside space-y-1">
                <li>Abre <strong>Ajustes → Notificaciones → Rucula</strong> y activa "Permitir notificaciones"</li>
                <li>Si usas <strong>Modo Enfoque</strong> (Focus), verifica que Rucula esté permitido</li>
